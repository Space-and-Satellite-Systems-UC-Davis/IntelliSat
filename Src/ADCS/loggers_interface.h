 ...
 * @returns           Whether push was successful (bool).
 */
bool push_mag(uint32_t* data_in);
 ...
 * @returns           Whether push was successful (bool).
 */
bool push_imu(uint32_t* data_in);
 ...
 * @param data_size    Must be 256 or 4096 bytes; else function will return 1.
 *
 * @returns            Whether push was successfully completed (bool).
 */
bool flash_push(uint32_t* data_out, uint16_t data_size);
 ...
 * @returns            Whether push was successfully completed (bool).
 */
bool fram_push(uint32_t* data_out, uint16_t data_size, uint16_t page);
 ...
 */
uint32_t* flash_pull(uint32_t* data_in);

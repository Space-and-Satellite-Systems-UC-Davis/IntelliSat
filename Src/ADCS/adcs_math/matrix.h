 ...
 * @return Void.
 */
void mat_set(double x1, double x2, double x3, double y1, double y2, double y3,
             double z1, double z2, double z3, mat3 *output);
 ...
 * @return Void.
 */
void mat_set_from_vec(vec3 first, vec3 second, vec3 third, mat3 *output);
...
/**
 * @brief Calculate the adjoint of a matric
 *
 * @param matrix The matrix for which to calculate the determinant.
 *

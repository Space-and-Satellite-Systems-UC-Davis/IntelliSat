 ...
 * @returns None
 */
// #define led_a(b) gpio_set(GPIOG, 11, b) // VIRTUAL
 ...
 * @returns None
 */
// #define led_b(b) gpio_set(GPIOG, 12, b) // VIRTUAL
 ...
 * @returns None
 */
// #define led_c(b) gpio_set(GPIOG, 9, b) // VIRTUAL
 ...
 * @returns None
 */
// #define led_fault(b) gpio_set(GPIOG, 7, b) // VIRTUAL
 ...
 * @returns None
 */
// #define led_ag(b) gpio_set(GPIOG, 6, b) // VIRTUAL
 ...
 * @returns None
 */
// #define led_hb(b) gpio_set(GPIOE, 2, b) // VIRTUAL

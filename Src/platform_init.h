...
#define SCB_CPACR_CPN_0 (0x01UL << SCB_CPACR_CPN_POS)
#define SCB_CPACR_CPN_1 (0x02UL << SCB_CPACR_CPN_POS)
...
void init_platform(bool run_scheduler) {
    SCB->CPACR |= SCB_CPACR_CPN_FULL_ACCESS << SCB_CPACR_CPN_POS; // Enable the Floating-Point Unit for full access
